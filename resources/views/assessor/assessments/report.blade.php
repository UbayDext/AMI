...
<body class="bg-white dark:bg-gray-800 text-black p-4 text-xs font-sans">
    ...
    <table class="w-full border-collapse sheet-table text-[10px]">
        <thead>
            <tr class="bg-gray-200 dark:bg-gray-700 text-center font-bold">
        ...
        <tbody>
            ...
            <tr class="{{ $bgClass }}">
                ...
                <td>
                    ...
                    @endif
                    @if($q->reference)
                    <div class="text-[9px] text-gray-500 dark:text-gray-400 mt-1">Ref: {{ $q->reference }}</div>
                    @endif
                </td>
            ...
            <tr class="bg-red-50">
                ...
                <td colspan="9" class="bg-gray-100 dark:bg-gray-800/80 text-center text-gray-400 dark:text-gray-500 italic">Independent finding - No structered PTK</td>
            </tr>
            @endforeach
            @endif
