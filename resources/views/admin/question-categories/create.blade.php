<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Create Question Category</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Tambah kategori baru untuk bank soal</p>
            </div>
