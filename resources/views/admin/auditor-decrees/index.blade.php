<x-app-layout>
    ...
    <div class="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4" x-data="{ showDeleteModal: false, deleteTargetName: '', deleteFormAction: '' }">
        @if(session('success'))
                    ...
                    <tr class="border-t">
                        ...
                        <td class="p-3">
                            <div class="flex items-center gap-2">
                                ...
                                <button type="button"
                                    @click.prevent="deleteTargetName = '{{ addslashes($row->decree_number ?? 'SK Tanpa Nomor') }}'; deleteFormAction = '{{ route('admin.auditor-decrees.destroy', $row) }}'; showDeleteModal = true;"
        ...
        <x-delete-modal title="Hapus SK Auditor?">
            Anda yakin ingin menghapus data surat keputusan <span class="text-white font-medium" x-text="deleteTargetName"></span> ini secara permanen?
        </x-delete-modal>
    </div>
</x-app-layout>